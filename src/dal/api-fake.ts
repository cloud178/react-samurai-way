...
export const getTrack = (trackId: string) => {
  console.log(trackId) // написал чисто для того чтобы IDE не ругалась что trackId is declared but is never read
...
export const getTracks = () => {
  const promise: Promise<GetTrackListOutputData> = Promise.resolve({
    data: [
      {
